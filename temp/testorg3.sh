...
# Invoke chaincode on peer0.supplier, peer0.manufacturer, and peer0.org3
echo "Sending invoke transaction on peer0.supplier peer0.manufacturer peer0.org3..."
chaincodeInvoke 0 1 0 2 0 3

# Query on chaincode on peer0.org3, peer0.manufacturer, peer0.supplier check if the result is 80
