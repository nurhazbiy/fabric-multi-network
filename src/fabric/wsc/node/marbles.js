...
let Chaincode = class {
     ...
     * @return {Promise<Buffer>} The wsc in the given range.
     */
    ...
    /**
     * Transfers wsc of a given color to a certain new owner.
     *
    ...
    /**
     * Queries for wsc based on a passed in owner.
     ...
     * @param {Chaincode} thisObject The chaincode object context.
     * @return {Promise<Buffer>} The wsc of the specified owner.
     */
    ...
    /**
     * Uses a query string to perform a query for wsc.
